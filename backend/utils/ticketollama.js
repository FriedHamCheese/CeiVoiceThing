...
export async function draftTicketFromUserRequest(userRequestText) {
    ...
    */
    ...
    if (!objectFromResponse.summary) {
        if (objectFromResponse.Summary) objectFromResponse.summary = objectFromResponse.Summary;
    }
    if (!objectFromResponse.title) {
        if (objectFromResponse.Title) objectFromResponse.title = objectFromResponse.Title;
    }
    ...
    if (!objectFromResponse.categories) {
        if (objectFromResponse.Categories) objectFromResponse.categories = objectFromResponse.Categories;
    }
